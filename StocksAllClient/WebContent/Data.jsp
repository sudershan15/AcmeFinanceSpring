  ...
  <table border="0" width="90%" cellspacing="0" cellpadding="0">
    <tr>
      <td width="99%" valign="top"><br/>
    		<form name="form1" id="form1" method="post" action="temporal"  >
			...
			<p>	<input type="radio" name="radioB"  value="xml" />XML<br />
 			...
 			<select name="ticker">
       <%
       		String sec=request.getParameter("Sector");
		...
		try{
			...
			rst=stmt.executeQuery("select ticker from ticker where sector='"+sec+"'");	
    ...
    %>  
			...
			<p>Start Date: <input type="text" name="text" id="text"  />
  			  To End Date: <input type="text" name="text1" id="text1"  />
  			</p>
